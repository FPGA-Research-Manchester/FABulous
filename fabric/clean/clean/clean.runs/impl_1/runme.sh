...
HD_PWD='R:/work/FORTE/FPGA/fabric/clean/clean/clean.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log emulation_wrapper_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source emulation_wrapper_top.tcl -notrace
