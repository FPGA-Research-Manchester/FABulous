...
HD_PWD='R:/work/FORTE/FPGA/fabric/clean/clean/clean.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log emulation_wrapper_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source emulation_wrapper_top.tcl
