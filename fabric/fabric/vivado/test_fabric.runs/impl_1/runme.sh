...
HD_PWD='R:/work/FORTE/FPGA/fabric/vivado/test_fabric.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eFPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eFPGA.tcl -notrace
