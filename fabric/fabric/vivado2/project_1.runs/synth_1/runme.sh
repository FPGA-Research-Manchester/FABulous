...
HD_PWD='R:/work/FORTE/FPGA/fabric/vivado2/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log eFPGA_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source eFPGA_top.tcl
