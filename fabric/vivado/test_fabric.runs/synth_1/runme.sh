...
HD_PWD='R:/work/FORTE/FPGA/fabric/vivado/test_fabric.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LUT4AB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LUT4AB.tcl
