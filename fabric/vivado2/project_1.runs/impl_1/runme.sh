...
HD_PWD='R:/work/FORTE/FPGA/fabric/vivado2/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log eFPGA_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source eFPGA_top.tcl -notrace
