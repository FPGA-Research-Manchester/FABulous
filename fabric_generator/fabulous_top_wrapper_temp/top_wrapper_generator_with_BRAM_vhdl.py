...
def main():
    ...
    try:
        with open(f"{FABulous_root}/fabric_generator/fabulous_top_wrapper_temp/eFPGA_v3_top_sky130_with_BRAM_template.vhdl", 'r') as file:
    ...
    try:
        with open(f"{FABulous_root}/fabric_generator/fabulous_top_wrapper_temp/Config_template.vhdl", 'r') as file:
    ...
    try:
        with open(f"{FABulous_root}/fabric_generator/fabulous_top_wrapper_temp/ConfigFSM_template.vhdl", 'r') as file:
    ...
    wrapper_top_str = wrapper_top_str.replace("FrameBitsPerRow : integer := 32;", f"FrameBitsPerRow : integer := {FrameBitsPerRow};")
    wrapper_top_str = wrapper_top_str.replace("FrameSelectWidth : integer := 5;", f"FrameSelectWidth : integer := {FrameSelectWidth};")
    wrapper_top_str = wrapper_top_str.replace("MaxFramesPerCol : integer := 20;", f"MaxFramesPerCol : integer := {MaxFramesPerCol};")
    wrapper_top_str = wrapper_top_str.replace("NumberOfCols : integer := 19;", f"NumberOfCols : integer := {NumberOfCols};")
    wrapper_top_str = wrapper_top_str.replace("NumberOfRows : integer := 16;", f"NumberOfRows : integer := {NumberOfRows};")
    wrapper_top_str = wrapper_top_str.replace("RowSelectWidth : integer := 5;", f"RowSelectWidth : integer := {RowSelectWidth};")
    wrapper_top_str = wrapper_top_str.replace("desync_flag : integer := 20;", f"desync_flag : integer := {desync_flag};")
    ...
    config_str = config_str.replace(
        "FrameBitsPerRow : integer := 32;", f"FrameBitsPerRow : integer := {FrameBitsPerRow};")
